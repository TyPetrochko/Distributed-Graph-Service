...
cross_platform:
	${CC} -std=c++11 -I ./include -g $^ main.cpp util.cpp persistence.cpp memorygraph.cpp include/mongoose.c include/JSON.cpp include/JSONValue.cpp -o cs426_graph_server
