...
cross_platform:
	${CC} -std=c++11 -I ./include -g ${CFLAGS} $^ persistence.cpp memorygraph.cpp include/mongoose.c include/JSON.cpp include/JSONValue.cpp -o cs426_graph_server

memorygraph: memorygraph.cpp memorygraph.hpp
	${CC} ${CFLAGS} memorygraph.cpp -o $@

main: main.cpp
	${CC} ${CFLAGS} $^ persistence.cpp memorygraph.cpp include/mongoose.c include/JSON.cpp include/JSONValue.cpp -o cs426_graph_server
